...
public class WebAutomation {
	...
	static public void login() {
		...
		driver.findElement(By.xpath("//input[@id='email']")).sendKeys("raj.officialwrkmail@gmail.com");
		driver.findElement(By.xpath("//input[@id='pass']")).sendKeys("Raju@081194");
	...
	static public void selectHotel() throws InterruptedException {
		...
		List<WebElement> txtPrice = hotelList.findElements(By.tagName("h2"));
